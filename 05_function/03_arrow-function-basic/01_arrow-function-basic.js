...
// 1-1. function 키워드 생략 가능
message = () => {
    return "Arrow Function!!!";
} 
console.log(message());

// 1-2. 명령문이 하나만 있는 경우, 중괄호 생략이 가능하다.
//      이때 함수 몸체 내부의 명령문이 값으로 평가 될 수 있는 표현식 문이라면 암묵적으로 반환된다.
//      return 키워드 생략 가능
...
// 2-1. 매개 변수가 한개면, 소괄호 생략 가능
//      하지만 매개변수가 없거나, 여러개일 경우, 생략은 불가능하다.
